...
var birthDay=0;
var theText=0;
var pizzaPrice=0, deliveryPrice=0, birthdayDiscount =0.1, pizzaTotal=0;
...
function placeOrder() {
    pizzaTotal = ((pizzaQuantity * pizzaPrice) * (1 - birthdayDiscount)) + deliveryPrice;
    theText = `<p>You bought ${pizzaQuantity} ${pizzaType} pizzas.</p>
    <p>Your delivery city is ${deliverCity} and your delivery price is ${deliveryPrice}.</p>
    <p>Your total is ${pizzaTotal}</p>`
